    ...
    return (
        <Col xl='4'>
            <Card color="white" className="shadow-lg mb-5 mx-4 p-4" >
                ...
                <CardTitle tag="h4" className="text-center">{props.doctor.name}</CardTitle>
                ...
                <NavLink to="/request" className=" d-block m-auto my-3 btn btn-outline-primary btn-lg px-3 pb-3 pt-2">Request an Issue</NavLink>
            </Card>
        </Col>
    );
}
